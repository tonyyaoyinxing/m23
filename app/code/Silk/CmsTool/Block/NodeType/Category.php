...
use Silk\CmsTool\Model\NodeType\Category as ModelCategory;
...
class Category extends AbstractNode
{
     ...
     * @var string
     */
    protected $defaultTemplate = 'block/node_type/category.phtml';

    /**
     * @var string
     */
    protected $customTemplateFolder = 'block/custom/category/';
