...
use Silk\CmsTool\Model\NodeType\CmsBlock as CmsBlockModel;
...
class CmsBlock extends AbstractNode
{
     ...
     * @var string
     */
    protected $defaultTemplate = 'block/node_type/cms_block.phtml';

    /**
     * @var string
     */
    protected $customTemplateFolder = 'block/custom/cms_block/';
