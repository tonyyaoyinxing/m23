...
use Silk\CmsTool\Model\NodeType\CmsPage as CmsPageModel;
...
class CmsPage extends AbstractNode
{
     ...
     * @var string
     */
    protected $defaultTemplate = 'block/node_type/cms_page.phtml';

    /**
     * @var string
     */
    protected $customTemplateFolder = 'block/custom/cms_page/';
