...
use Silk\CmsTool\Model\NodeType\CustomUrl as CustomUrlModel;
...
class CustomUrl extends AbstractNode
{
     ...
     * @var string
     */
    protected $defaultTemplate = 'block/node_type/custom_url.phtml';

    /**
     * @var string
     */
    protected $customTemplateFolder = 'block/custom/custom_url/';
