...
namespace Silk\CmsTool\Block\NodeType;

use Magento\Framework\Registry;
use Magento\Framework\UrlInterface;
use Silk\CmsTool\Model\TemplateResolver;
use Magento\Framework\View\Element\Template\Context;
use Silk\CmsTool\Model\NodeType\Product as ModelProduct;
use Magento\Framework\Pricing\Helper\Data as PricingHelper;
use Silk\CmsTool\Helper\Image as ImageHelper;
...
class Product extends AbstractNode
{
     ...
     * @var string
     */
    protected $defaultTemplate = 'block/node_type/product.phtml';

    /**
     * @var string
     */
    protected $customTemplateFolder = 'block/custom/product/';
