...
use Silk\CmsTool\Model\NodeType\Wrapper as WrapperModel;
...
class Wrapper extends AbstractNode
{
     ...
     * @var string
     */
    protected $defaultTemplate = 'block/node_type/wrapper.phtml';

    /**
     * @var string
     */
    protected $customTemplateFolder = 'block/custom/wrapper/';
