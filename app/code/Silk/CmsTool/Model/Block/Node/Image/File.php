...
namespace Silk\CmsTool\Model\Block\Node\Image;
...
class File
{
    ...
    public function upload(): array
    {
        ...
        $uploader->addValidateCallback('block_node_image', $imageAdapter, 'validateUploadFile');
